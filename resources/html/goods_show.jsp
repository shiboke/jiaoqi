  ...
  <div id="banner"> 
   <div id="Focus"> 
    <ul> 
     ...
     <li><img src="${ctx.path}/resources/images/banner02.jpg" /></li> 
     <li><img src="${ctx.path}/resources/images/banner03.jpg" /></li> 
    </ul> 
   </div> 
  </div> 
  <!--head结束--> 
  <div id="body"> 
   ...
   <div class="left"> 
    <div class="pro"> 
     ...
     <div class="proc"> 
      <img src="${ctx.path}/resources/images/1_02.jpg" />
      <br />
      <img src="${ctx.path}/resources/images/1_07.jpg" /> 
      <div class="clear"></div> 
      <div class="page"> 
      </div> 
     </div> 
